...
{
    public class DUIParentRotateAngleChangingEventArgs
    {
        ...
        public DUIParentRotateAngleChangingEventArgs(DUIControl control, float newRotateAngle, float oldRotateAngle)
        {
