...
{
    public class DUIPolygonAnyChangingEventArgs
    {
        ...
        public DUIPolygonAnyChangingEventArgs(RectangleF newBounds, RectangleF oldBounds, PointF newCenter, PointF oldCenter, PointF newSkew, PointF oldSkew, PointF newScale, PointF oldScale, float newRotateAngle, float oldRotateAngle, PointF[] newPolygon, PointF[] oldPolygon)
        {
