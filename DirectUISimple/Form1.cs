...
namespace DirectUISimple
{
    public partial class Form1 : Form
    {
        ...
        {
            InitializeComponent();
            DirectUI.Core.DUIScaleableControl dUIScaleableControl = new DirectUI.Core.DUIScaleableControl() { Dock = DockStyle.Fill, BackgroundImage = DirectUI.Common.DUIImage.FromImage(global::DirectUISimple.Properties.Resources._2) };
